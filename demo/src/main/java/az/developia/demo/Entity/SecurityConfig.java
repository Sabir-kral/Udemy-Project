    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/students/profile").hasAuthority("Student")
                        .requestMatchers(HttpMethod.DELETE, "/api/students/delete").hasAuthority("Student")
                        .requestMatchers(HttpMethod.POST, "/api/auth/login").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/students/profile").hasAuthority("Student")
                        .requestMatchers(HttpMethod.POST, "/api/teachers/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/teachers/profile").hasAuthority("Teacher")
                        .requestMatchers(HttpMethod.DELETE, "/api/teachers/delete").hasAuthority("Teacher")
                        .requestMatchers(HttpMethod.GET, "/api/teachers/my-students").hasAuthority("Teacher")
